...
function Library:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "BadBull-MrOhio"
	...
	WindowConfig.IntroText = WindowConfig.IntroText or "Starting Script.."
	...
	local WindowStuff = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 10), {
		...
		SetChildren(SetProps(MakeElement("TFrame"), {
			...
			AddThemeObject(SetProps(MakeElement("Label", "#WeAreBetterThanNova", WindowConfig.HidePremium and 14 or 13), {
